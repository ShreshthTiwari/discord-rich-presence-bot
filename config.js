module.exports = {
  ...
  IMAGE_NAME: 'omigawd', //Name of the image that you uploaded in rich presence, assets.
  BUTTON_1_URL: 'https://youtu.be/dQw4w9WgXcQ', //URL that will open when somebody presses the first button.
